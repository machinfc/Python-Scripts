# This script manually obtains a new profile, exports the distance and height values of the new profile,
# and prints its slopes.
import os
import csv
...
output_filename = os.path.join(output_folder, f'{os.path.basename(filename).replace(".npz", "")}_profile_new.csv')
